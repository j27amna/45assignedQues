...
// Ques #5
let famousPerson = "Benjamin Franklin";
let message = "Remember that time is money";
...
// Ques #11
let friendNames = ["Laiba", "Maha", "Shanza", "Zahra"];
...
;
// Ques #14
let guestList = ["Elsa", "Ozge", "Leyla"];
for (let i = 0; i < guestList.length; i++) {
    console.log(`Dear ${guestList[i]},\n I invite you to dinner party of collegues held at my place.\n`);
}
;
// Ques #15
let absentGuest = "Elsa";
let newGuest = "Mildred";
...
// Ques #18
let countries = ["Karachi", "Hyderabad", "Peshawar", "Lahore"];
...
// Ques #20
let novelsArray = ["Peer-e-kamil", "Jannat k pattay", "Mala", "Amar bail", "Haalim", "Mushaf"];
...
console.log(car !== 'honda');
// Ques #24
console.log("Equality test:", "Chocolate" === "Chocolate");
console.log("Inequality test:", "Chocolate" !== "chocolate");
console.log("Lowercase:", "VANILLA".toLowerCase() === "vanilla");
console.log("Numerical equality test:", 98 === 98);
console.log("Numerical inequality test:", 98 !== 95);
...
// Ques #25
let alien_colour = "green" || "yellow" || "red";
...
;
// Ques #29
let Favfruit = ["Mango", "Banana", "Strawberry"];
...
;
// Ques #30
let userName = ["Admin", "Afia", "Shafia", "Hania", "Maleeha"];
...
;
// Ques #32
let currentUsers = ['Cackle', 'John', 'Hardbroom', 'Moad', 'Enid'];
let newUsers = ['Cackle', 'Agatha', 'Bat', 'Hubble', 'Enid'];
...
// Ques #45
function createCar(carManufracturer, carModel, year, ...options) {
    let car = {
